 ...
 * Showcases Xgrowth Company's creative work with minimal, elegant design.
 */
          ...
          <ScrollReveal>
            <div className="text-center mb-16 space-y-4 px-6">
              ...
              <p className="text-lg text-muted-foreground font-light tracking-wide">
                Uma selecao inicial de criativos e materiais digitais
              </p>
            </div>
          </ScrollReveal>
